...
const Uploader = ({ files = [], remove }) => {
  return (
    <div className="uploader"
      style={{
        width: '500px', minHeight: '128px', position: 'fixed',
        right: '18px', top: '18px', maxHeight: '700px',
        overflowY: 'auto'
      }}
    >
      <div className="card">
        <div className="card-header"
          style={{
            color: '#fff', backgroundColor: 'rgb(93 11 11 / 92%)'
          }}>Subir Archivo</div>
...
const UploadItem = ({ idPaciente, IdAtencion, data, setAtenciones, setAtencion, atencion, viejaAte, cantArch, removeFile }) => {
    ...
    <li className="list-group-item">
      <div className="row">
        <div className="col-12 d-flex">
          <div className="d-inline font-weight-bold text-truncate">Subiendo {uploadInfo.cantidad} Archivo{uploadInfo.cantidad > 1 && <>s</>}</div>
